        ...
        <MainLayout>
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Kelola aset dan inventaris perusahaan</p>
                </div>
            </div>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-amber-700 dark:text-amber-400 text-sm">
                            Modul Inventory sedang dalam tahap pengembangan dan akan segera tersedia.
                        </p>
                    </div>
                </div>
            </div>
