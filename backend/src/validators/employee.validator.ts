...
export const createKaryawanSchema = z.object({
    ...
    nomorHandphone2: z.string().max(20).optional().nullable(),
    nomorTeleponRumah1: z.string().max(20).optional().nullable(),
    nomorTeleponRumah2: z.string().max(20).optional().nullable(),
    ...
    nomorTeleponKontakDarurat1: z.string().max(20).optional().nullable(),
    ...
    nomorTeleponKontakDarurat2: z.string().max(20).optional().nullable(),
